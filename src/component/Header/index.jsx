...
const Header = ({ clicked, index }) => {
  const items = [
    ...
    { img: "./images/cat4.svg", category: "Iconic Cities" },
    { img: "./images/cat5.svg", category: "Houseboats" },
    { img: "./images/cat6.svg", category: "Countryside" },
    { img: "./images/cat7.svg", category: "Camping" },
    { img: "./images/cat8.svg", category: "Castles" },
    { img: "./images/cat9.svg", category: "Skiing" },
    { img: "./images/cat10.svg", category: "Tropical" },
  ];
  ...
  return (
    <Box
      sx={{
        backgroundImage: "url(./images/headimg.svg)",
